...
![img](1.%E5%88%9B%E5%BB%BA%E5%9E%8B%E6%A8%A1%E5%BC%8F.assets/rj_102520250107110801.png)
...
func main() {
	aliPayFactory := AliPayFactory{}
	aliPay := aliPayFactory.CreatePay()
	fmt.Println(aliPay.PayPage(15)) // 支付宝支付
	aliPayFactory.CreateRefund().Refund("") // 支付宝退款啦

	weiXinPayFactory := WeiXinPayFactory{}
	weiXinPay := weiXinPayFactory.CreatePay()
	fmt.Println(weiXinPay.PayPage(15)) // 微信支付
	weiXinPayFactory.CreateRefund().Refund("") // 微信退款啦
}
```
